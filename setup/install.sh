...
echo "    4. Install and patch happy-coder (mobile access)"
echo "    5. Deploy helper scripts"
echo "    6. Deploy global CLAUDE.md"
echo "    7. Configure WSL settings (git, credentials, bashrc)"
echo ""
...
echo "  2. Run: mclaude"
echo ""
echo -e "${COLOR_BLUE}For mobile access:${COLOR_RESET}"
echo "  Run: happy"
echo ""
echo -e "${COLOR_BLUE}Logs:${COLOR_RESET}"
echo "  Check ~/.wsl-claude-setup/logs/ for detailed logs"
echo ""
