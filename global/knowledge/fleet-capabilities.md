...
The fleet runs whichever Opus version `mclaude` (via `cc-mirror`) bundles at install time. The relevant models today (Fable 5 — id `claude-fable-5`, a tier above Opus — is **selectable from this fleet, verified 2026-07-06**; route the hardest reasoning + all red-team checkpoints there):
...
| **Fable 5** | ⚠ **Reachable but ON COST HOLD from 2026-07-08** — verified WSL 2026-07-06 (id `claude-fable-5`) | — | — | **⚠ COST HOLD (user directive 2026-07-07): do NOT route to Fable until cost impact confirmed — use Opus 4.8. Preview flagship (2026-06-09), a tier above Opus.** **Money-gated** (not geo-blocked): re-deployed globally 2026-07-01; subscription-included (≤50% of weekly limit) **through 2026-07-07**, then **metered usage credits from 2026-07-08** at API rates ($10/M in, $50/M out); Anthropic aims to restore to plans 'until better availability.' See the Fable 5 section below. |
...
> **✅ AVAILABLE TO THIS FLEET (verified 2026-07-06, live subagent run on WSL):** The `fable` subagent (`model: claude-fable-5`) and `--model fable` work from this fleet. This supersedes the 2026-06-17 "geo-blocked / unavailable" note, which was stale and self-perpetuating. It is NOT geo-blocked — it is **money-gated**: subscription-included (≤50% of weekly limit) through 2026-07-07, then **metered usage credits from 2026-07-08** at API rates (see Pricing/credits below); Anthropic aims to restore it to plans "until better availability." Use it deliberately (it costs). **⚠ COST HOLD from 2026-07-08 (user directive 2026-07-07): do NOT route to Fable until the user confirms it incurs no extra/metered cost — use Opus 4.8 for the hardest reasoning + ALL red-team until cleared. Fable was fine through 2026-07-07 (subscription window).** Treat any future "unavailable" claim as a hypothesis to test by launching the agent, never a standing fact.
